...
const Login: React.FC = () => {
  return (
    <div className="relative min-h-screen w-full overflow-hidden bg-[#0F172A]">
      ...
      {/* 로고 및 서비스 이름 */}
      <div className="fixed top-6 left-1/2 -translate-x-1/2 z-30 flex items-center gap-2 lg:left-8 lg:top-8 lg:translate-x-0 lg:gap-4">
        <img 
          src="/logo.png" 
          alt="TEAMITZ" 
          className="h-8 w-8 lg:h-16 lg:w-16 object-contain"
        />
        <span className={`${TEXT_STYLES.size.lg} lg:text-5xl ${TEXT_STYLES.weight.semibold} text-white`}>
          TEAMITZ
        </span>
      </div>
      ...
      <div className="relative z-10 flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 relative">
          {/* 부드러운 그라데이션 오버레이 */}
          <div className="absolute inset-0 bg-gradient-to-r from-[#2563EB]/6 via-[#2563EB]/2 to-transparent" />
          <HeroSection />
        </div>
